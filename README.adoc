== This is not yet released, and is currently blocked by https://issues.sonatype.org/browse/OSSRH-27167 before we can do so. Please use the old project for now located at https://github.com/SpectoLabs/hoverfly-junit
