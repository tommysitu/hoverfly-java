...
- No need to change the host that you point to - Hoverfly is a proxy
- Multiple hosts / services per single instance of Hoverfly. No need to create more than one.
